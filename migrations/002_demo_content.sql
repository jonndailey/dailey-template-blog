...
INSERT INTO posts (title, slug, content, excerpt, category_id, tags, published, published_at) VALUES (
  ...
  'After 14 months of R&D and 200+ customer interviews, we completely rebuilt Velo from the ground up. Timeline views, smart assignments, instant reports, and real-time collaboration — here is everything that changed and why.',
...
INSERT INTO posts (title, slug, content, excerpt, category_id, tags, published, published_at) VALUES (
  ...
  'Our API p99 latency dropped from 500ms to 45ms. Task throughput jumped from 50/sec to 3,000/sec. Here is exactly how we re-architected Velo to handle 1 million tasks per day — without a single minute of downtime.',
...
INSERT INTO posts (title, slug, content, excerpt, category_id, tags, published, published_at) VALUES (
  ...
  'Led by Craft Ventures with participation from Y Combinator and Founders Fund, this round fuels our plans to triple the engineering team, launch enterprise features, and expand into Europe.',
...
INSERT INTO posts (title, slug, content, excerpt, category_id, tags, published, published_at) VALUES (
  ...
  'A 45-person Austin design agency replaced four tools with Velo. The result: 40% faster project delivery, zero missed deadlines, and creative directors reclaiming 3 hours every week.',
...
INSERT INTO posts (title, slug, content, excerpt, category_id, tags, published, published_at) VALUES (
  ...
  'PostgreSQL wins on Hacker News, but MySQL wins in our benchmarks. We break down the real-world tradeoffs that guided our decision — and the one mistake we would fix if we could go back.',
  (SELECT id FROM categories WHERE slug = 'engineering'),
